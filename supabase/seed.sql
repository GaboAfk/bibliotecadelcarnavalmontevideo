...
-- STATIC CONTENT
-- ============================================================
INSERT INTO static_content (id, title, body) VALUES (
    'nuestra-biblioteca',
    'Nuestra Biblioteca',
    'La Biblioteca Oficial del Carnaval funciona desde la convicción de que sólo existe la cultura si la misma es puesta en valor. Cada libreto, fotografía y recuerdo de nuestro carnaval es una identidad que forma parte de nuestra historia colectiva...'
);
...
-- FRASES PROMO
-- ============================================================
INSERT INTO frases_promo (image, subtitle, title, sort_order, active) VALUES
